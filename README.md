...
The system provides a console-based interface that allows users to manage employee records. Data is stored in memory using ArrayList and persisted to a text file to ensure it is retained between program runs.
